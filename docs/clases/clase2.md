...
| 1:10 – 1:27 | Trabajo en clase sobre el **Entregable 1**: "de problema de negocio a problema de predicción" |
...
la predicción permite tomar mejor y más temprano — la misma idea que van a aplicar en el Entregable 1
de hoy.
