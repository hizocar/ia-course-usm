...
Los mismos grupos de 3-4 personas formados en la actividad de la
[Clase 1](clases/clase1.md#actividad-formativa-radar-estrategico-de-ia) trabajan juntos **todo el
...
o de IA Generativa, y estimar cuánto vale tomar una mejor decisión gracias a ese modelo.
...
| Herramienta | Para qué la pueden usar en el proyecto |
|---|---|
| **ChatGPT** (GPTs personalizados, Advanced Data Analysis) | Prototipar un asistente con instrucciones propias; explorar datos y generar gráficos sin programar |
| **Claude** (Projects, Artifacts) | Trabajar sobre documentos largos del proyecto (planes, contratos, informes) que se van refinando junto con el equipo |
| **Gemini** (Gems, Workspace) | Prototipar un asistente integrado a Docs/Sheets/Gmail; búsqueda y contenido multimodal |
| **Zapier / Make.com** | Automatizar un flujo de negocio simple combinando un disparador con un paso de IA Generativa |
| **Gamma.app** (u otra herramienta de IA para presentaciones) | Generar rápido un primer borrador visual del pitch final, para luego editarlo con criterio propio |

> ⚠️ Ninguna herramienta es obligatoria por sí sola: el criterio de elección es **qué resuelve mejor
> el problema del equipo**, no usar la herramienta más nueva. Revisen los límites (alucinaciones,
> confidencialidad) discutidos en la [Clase 1](clases/clase1.md#3-ia-generativa-en-la-practica-chatgpt-claude-y-gemini).
